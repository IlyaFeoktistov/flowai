...
- **`.flowai/skills/find-bottlenecks.py`** — `/find-bottlenecks [фокус]`
  ...
  сессии).
- **`.flowai/skills/release-notes/SKILL.md`** — скилл в формате Claude
  Code (markdown + frontmatter). Модель сама вызывает его, когда просят
  «составь release notes», или вручную: `/release-notes [фокус]`. Рядом
  лежит `template.md`, на который ссылаются инструкции. Такие же скиллы
  можно класть в `~/.flowai/skills/` — тогда они видны во всех проектах.
